...
The course consists of the following 8 modules.  A rough schedule is that we will do one module per week in each of the first three weeks, then two modules per week in weeks 4 and 5, then do the last module in week 6.  
