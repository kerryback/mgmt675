...
4. How to use agentic AI to replace dashboards (and other things) with natural language prompts
...
8. Replacing dashboards with natural language prompts
9. Automated as-needed loading of specialized prompts
10. Using AI inside an integrated development environment (IDE)
11. Using AI for discounted cash flow valuation of companies
12. Retrieval augmented generation
13. Fine-tuning and small language models
14. Building an AI agent
