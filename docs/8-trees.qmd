...
- Ask Julius to train and test a random forest regressor to predict y1 in irrelevant_features.xlsx.
- Ask Julius to use GridSearchCV to find the best max_depth in (5, 10, 15, 20).
- Ask Julius to train and test a gradient boosting regressor to predict y1 in irrelevant_features.xlsx.
