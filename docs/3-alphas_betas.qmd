...
# Cost of Capital and Performance Evaluation{background-image="https://www.dropbox.com/scl/fi/jerhfe2cad1jtdvapik71/gpt_image.jpg?rlkey=2dnc3qyozkm24tcl2pzjccxka&dl=1" background-position="top" background-opacity="0.2"}
...
- Ask Julius to use plotly to create a regplot of the excess Yahoo returns on the excess market return and to include the date in the hover data.  Ask Julius to save as html.
