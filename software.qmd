...
The installer also sets up VS Code extensions (Python, Jupyter, Claude Code, GitHub Copilot, LaTeX Workshop, Quarto) and pre-configured Claude skills (xlsx, docx, pptx, skill-creator).
