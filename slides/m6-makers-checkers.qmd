...
- Or you can use year 5, year 6, ... as the terminal year.  It doesn't matter.  Just include [at least the first year of constant income growth]{.amber} as part of Stage 1.
...
*/skill-creator I want a 2-stage-dcf skill that use your xlsx skill to generate a two-stage DCF analysis.  I want these rules to be followed ...*
