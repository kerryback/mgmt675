...
\begin{shadedbox}[title=\textbf{Prompt to Claude Code}]
...
\begin{baritemize}
  ...
  \item This pattern is universal: Custom GPTs, Copilot instructions, \texttt{.cursorrules}, Gems
  \item A skill is just a system prompt extension---extra text the model sees
  \end{baritemize}
\end{frame}
