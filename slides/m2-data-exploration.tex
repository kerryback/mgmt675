...
\begin{columns}[T]
\begin{column}{0.5\textwidth}
\begin{shadedbox}[title=\textbf{First-Order}]
\begin{itemize}\small
...
\end{column}
\begin{column}{0.5\textwidth}
\begin{shadedbox}[title=\textbf{Second-Order}]
\begin{itemize}\small
...
\begin{enumerate}\small
  ...
  \item For each scenario: what's the impact on revenue, cost, and strategy?
  \item Identify actions that perform well \textit{across} scenarios
\end{enumerate}
\end{shadedbox}
\end{column}
\begin{column}{0.5\textwidth}
