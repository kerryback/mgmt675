...
You cannot edit Anthropic's document skills directly --- but you can create a [custom skill that extends one]{.amber}.
...
:::{.explainer}
This works in [Claude Desktop and Claude Code]{.amber}. The custom skill's instructions sit on top of the built-in skill's behavior --- you only need to specify what's different.
:::
