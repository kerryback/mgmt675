...
Skills also work in the **claude.ai** web interface --- no Claude Code required.

Go to **Settings → Capabilities → Skills**, then click the link to the **Customize** page.

:::{.two-cards}
:::{.card .card-light}
[**Anthropic Skills**]{.card-title}

- Excel, Word, PowerPoint, and PDF creation
- Toggle each skill on or off
- Claude automatically invokes the right skill based on your request
:::

:::{.card .card-light}
[**Custom Skills**]{.card-title}

- Click **+** to upload a **ZIP file** containing a folder with a `SKILL.md` file
- Same `SKILL.md` format as Claude Code skills
- Toggle on/off just like the built-in skills
:::
:::
