---
title: "Module 11: Sentiment Analysis"
...
```{mermaid}
%%| fig-width: 16
%%{init: {'theme': 'base', 'themeVariables': {'fontSize': '28px'}, 'flowchart': {'nodeSpacing': 60, 'rankSpacing': 120, 'padding': 24, 'useMaxWidth': true}}}%%
flowchart LR
  A["<b>All<br>Headlines</b>"] --> B["<b>FinBERT</b><br><i>~5ms</i>"]
  B -->|"high conf."| C["<b>Immediate<br>Signal</b>"]
  B -->|"low conf."| D["<b>GPT-4</b><br><i>~1-5s</i>"]
  D --> E["<b>Enhanced<br>Signal</b>"]

  style A fill:#eff6ff,stroke:#0f172a,stroke-width:2px,color:#0f172a,font-size:28px,padding:20px
  style B fill:#dbeafe,stroke:#3b82f6,stroke-width:2px,color:#0f172a,font-size:28px,padding:20px
  style C fill:#eff6ff,stroke:#0f172a,stroke-width:2px,color:#0f172a,font-size:28px,padding:20px
  style D fill:#fef3c7,stroke:#f59e0b,stroke-width:2px,color:#0f172a,font-size:28px,padding:20px
  style E fill:#eff6ff,stroke:#0f172a,stroke-width:2px,color:#0f172a,font-size:28px,padding:20px
```
...
The [tone of an earnings call]{.amber} often matters more for stock returns than the reported numbers. LLMs excel at tone analysis.
