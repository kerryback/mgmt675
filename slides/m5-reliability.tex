...
\title{Module 5: Verification and Governance}
\author{Kerry Back}
\date{}
...
\begin{enumerate}
  \item \textbf{RAG citations}: Ground answers in source documents with traceable references (Module 9). AI answers based on \alert{your content}, not its training data.
