...
\begin{itemize}
  ...
  \item Skills also work in \textbf{Claude.ai} (upload ZIP) and \textbf{Cowork} (install as plugin)
\end{itemize}
\vspace{0.3cm}
\begin{itemize}
  \item \textbf{Claude.ai (web):} upload a ZIP in Settings --- invoke automatically or with \texttt{/name}
  \item \textbf{Code tab / CLI:} place in \texttt{.claude/skills/} --- invoke automatically or with \texttt{/name}
\end{itemize}
\end{frame}
