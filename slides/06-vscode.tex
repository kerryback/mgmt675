...
\vspace{0.3cm}
\begin{shadedbox}
\centering\href{https://kerryback.com/mgmt675/software.html}{Software Installation Page}
\end{shadedbox}
\end{frame}
...
\begin{center}
\begin{shadedbox}[width=0.7\textwidth]
\centering\href{https://kerryback.com/mgmt675/exercises/objects.ipynb}{Download objects.ipynb}
\end{shadedbox}
\end{center}
\end{frame}
...
\begin{center}
\begin{shadedbox}[width=0.7\textwidth]
\centering\href{https://kerryback.com/mgmt675/exercises/betas.xlsx}{Data for the beta exercise}
\end{shadedbox}
\end{center}
\end{frame}
...
\begin{center}
\begin{shadedbox}[width=0.7\textwidth]
\centering\href{https://kerryback.com/mgmt675/exercises/aggregation.zip}{Zip file for the table aggregation exercise}
\end{shadedbox}
\end{center}
\end{frame}
