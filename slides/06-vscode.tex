...
\begin{frame}{Install from Course Site}
\begin{baritemize}
  \item Python 3.12
  ...
  \item Claude Code
  \item Koyeb CLI
  \item API authentication: GitHub, Anthropic, Koyeb
\end{baritemize}
\vspace{0.3cm}
\centering\small\url{https://kerryback.com/mgmt675/software.html}
\end{frame}
...
\begin{center}
\begin{shadedbox}[width=0.7\textwidth]
\centering\href{https://kerryback.com/mgmt675/exercises/aggregation.zip}{Download aggregation.zip}
\end{shadedbox}
\end{center}
\end{frame}
...
\begin{center}
\begin{shadedbox}[width=0.7\textwidth]
\centering\href{https://kerryback.com/mgmt675/exercises/betas.xlsx}{Download betas.xlsx}
\end{shadedbox}
\end{center}
\end{frame}
