...
\begin{baritemize}
  ...
  \begin{itemize}
    \item \textbf{Cursor}: AI-optimized editor (looks like VS Code)
    \item \textbf{GitHub Copilot}: Autocomplete while you type
    \item \textbf{Google Antigravity}: Newest entry (Gemini-powered)
  \end{itemize}
...
\begin{shadedbox}
\centerline{They're designed for different tasks}
\end{shadedbox}
...
\begin{baritemize}
  ...
  \item Many professional developers use multiple tools
\end{baritemize}
\end{frame}
