...
\begin{enumerate}
  \item Start a new conversation and ask Claude to critique your Module 2 DCF model --- identify 3+ questionable assumptions.
  \item Revise the model based on the critique.
...
\begin{enumerate}
  ...
  \item Document failures, fix SKILL.md, and submit: original + revised SKILL.md, adversarial queries, and failures found.
\end{enumerate}
\end{frame}
...
\begin{enumerate}
  ...
  \begin{itemize}\small
    ...
    \item When human review is required and how session logs should be archived
  \end{itemize}
\end{enumerate}
\end{frame}
