...
3. To open additional sessions in separate tabs, click the [open-in-new-tab icon]{.amber} (square with arrow) at the top of the Claude panel

Each tab is an independent conversation. Use multiple tabs to work on different tasks in parallel --- e.g., one for coding, one for questions.
:::
