...
```{mermaid}
%%| fig-width: 16
%%{init: {'theme': 'base', 'themeVariables': {'fontSize': '42px', 'primaryColor': '#fff', 'primaryTextColor': '#fff', 'lineColor': '#fff', 'clusterBkg': 'transparent', 'clusterBorder': '#fff'}, 'flowchart': {'nodeSpacing': 60, 'rankSpacing': 120, 'padding': 20, 'useMaxWidth': true}}}%%
graph TB
  ...
  style A1 fill:#fff,stroke:#fff
  style A2 fill:#fff,stroke:#fff
  style A3 fill:#fff,stroke:#fff
  style A4 fill:#fff,stroke:#fff
  style A5 fill:#fff,stroke:#fff
  style A6 fill:#fff,stroke:#fff
  style B1 fill:#fff,stroke:#fff
  style B2 fill:#fff,stroke:#fff
  style B3 fill:#fff,stroke:#fff
  style B4 fill:#fff,stroke:#fff
  style B5 fill:#fff,stroke:#fff
  style B6 fill:#fff,stroke:#fff
```
...
```{mermaid}
%%| fig-width: 16
%%{init: {'theme': 'base', 'themeVariables': {'fontSize': '42px', 'primaryColor': '#fff', 'primaryTextColor': '#fff', 'lineColor': '#fff', 'clusterBkg': 'transparent', 'clusterBorder': '#f59e0b'}, 'flowchart': {'nodeSpacing': 60, 'rankSpacing': 120, 'padding': 20, 'useMaxWidth': true}}}%%
graph TB
  subgraph Layer_k["Layer k"]
    direction LR
    A1((" "))
