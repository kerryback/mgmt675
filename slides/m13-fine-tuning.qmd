...
```{mermaid}
%%| fig-width: 16
%%{init: {'theme': 'base', 'themeVariables': {'fontSize': '42px', 'primaryColor': '#3b82f6', 'primaryTextColor': '#fff', 'lineColor': '#3b82f6', 'clusterBkg': '#eff6ff', 'clusterBorder': '#3b82f6'}, 'flowchart': {'nodeSpacing': 60, 'rankSpacing': 120, 'padding': 20, 'useMaxWidth': true}}}%%
graph TB
  ...
  style B1 fill:#3b82f6,stroke:#3b82f6,color:#fff
  style B2 fill:#3b82f6,stroke:#3b82f6,color:#fff
  style B3 fill:#3b82f6,stroke:#3b82f6,color:#fff
  style B4 fill:#3b82f6,stroke:#3b82f6,color:#fff
  style B5 fill:#3b82f6,stroke:#3b82f6,color:#fff
  style B6 fill:#3b82f6,stroke:#3b82f6,color:#fff
```
...
```{mermaid}
%%| fig-width: 16
%%{init: {'theme': 'base', 'themeVariables': {'fontSize': '42px', 'primaryColor': '#f59e0b', 'primaryTextColor': '#fff', 'lineColor': '#f59e0b', 'clusterBkg': '#eff6ff', 'clusterBorder': '#f59e0b'}, 'flowchart': {'nodeSpacing': 60, 'rankSpacing': 120, 'padding': 20, 'useMaxWidth': true}}}%%
graph TB
  subgraph Layer_k["Layer k"]
    direction LR
    A1((" "))
  ...
  style A1 fill:#f59e0b,stroke:#f59e0b,color:#fff
  style A2 fill:#f59e0b,stroke:#f59e0b,color:#fff
  style A3 fill:#f59e0b,stroke:#f59e0b,color:#fff
  style A4 fill:#f59e0b,stroke:#f59e0b,color:#fff
  style A5 fill:#f59e0b,stroke:#f59e0b,color:#fff
  style A6 fill:#f59e0b,stroke:#f59e0b,color:#fff
  style R1 fill:#f59e0b,stroke:#f59e0b,color:#fff
  style R2 fill:#f59e0b,stroke:#f59e0b,color:#fff
  style B1 fill:#f59e0b,stroke:#f59e0b,color:#fff
  style B2 fill:#f59e0b,stroke:#f59e0b,color:#fff
  style B3 fill:#f59e0b,stroke:#f59e0b,color:#fff
  style B4 fill:#f59e0b,stroke:#f59e0b,color:#fff
  style B5 fill:#f59e0b,stroke:#f59e0b,color:#fff
  style B6 fill:#f59e0b,stroke:#f59e0b,color:#fff
```
...
:::{.explainer}
Both paths feed the [same]{.amber} Layer k+1 nodes --- outputs are added element-wise: W × input + BA × input. After training, merge into a single matrix W_new = W + BA with [no inference overhead]{.amber}.
:::
