...
```{mermaid}
%%| fig-width: 16
%%{init: {'theme': 'base', 'themeVariables': {'fontSize': '42px', 'lineColor': '#f59e0b'}, 'flowchart': {'nodeSpacing': 80, 'rankSpacing': 140, 'padding': 20, 'useMaxWidth': true}}}%%
flowchart TB
  A1((" ")) ~~~ A2((" ")) ~~~ A3((" ")) ~~~ A4((" ")) ~~~ A5((" ")) ~~~ A6((" "))
  B1((" ")) ~~~ B2((" ")) ~~~ B3((" ")) ~~~ B4((" ")) ~~~ B5((" ")) ~~~ B6((" "))
...
**Layer k** → **Layer k+1**: [**36 trainable connections**]{.amber} --- all weights updated during training.

## LoRA (Rank 2): Low-Rank Update Path {.mermaid-small}

```{mermaid}
%%| fig-width: 16
%%{init: {'theme': 'base', 'themeVariables': {'fontSize': '42px', 'lineColor': '#f59e0b'}, 'flowchart': {'nodeSpacing': 80, 'rankSpacing': 100, 'padding': 20, 'useMaxWidth': true}}}%%
flowchart TB
  A1((" ")) ~~~ A2((" ")) ~~~ A3((" ")) ~~~ A4((" ")) ~~~ A5((" ")) ~~~ A6((" "))
  R1((" ")) ~~~ R2((" "))
  B1((" ")) ~~~ B2((" ")) ~~~ B3((" ")) ~~~ B4((" ")) ~~~ B5((" ")) ~~~ B6((" "))
