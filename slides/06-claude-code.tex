...
\begin{itemize}
  ...
  \item \textbf{Production path}---code saved in your repo, ready to deploy
\end{itemize}
\end{frame}
...
\vspace{0.3cm}
\textbf{Strategies for the Pro plan (\$20/month)}
\begin{enumerate}
  \item \textbf{Use Chat for questions, Code for analysis} --- match the tool to the task
...
\begin{center}
\href{https://kerryback.com/mgmt675/files/loans.zip}{Download Data for Exercise}
\end{center}
\end{frame}
...
\begin{center}
\href{https://kerryback.com/mgmt675/files/aggregation.zip}{Download Data for Exercise}
\end{center}
\end{frame}
