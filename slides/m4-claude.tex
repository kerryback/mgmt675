...
\begin{enumerate}\small
  \item Download \texttt{install.sh}
  \item Open \textbf{Terminal}
  \item Navigate to your Downloads folder:\\[2pt]
    \texttt{\footnotesize cd \textasciitilde/Downloads}
  \item Make it executable:\\[2pt]
    \texttt{\footnotesize chmod +x install.sh}
  \item Run it:\\[2pt]
    \texttt{\footnotesize ./install.sh}
\end{enumerate}
\end{shadedbox}
\end{column}
\end{columns}
