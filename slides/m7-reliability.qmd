...
- **Barclays**: 50K+ workloads migrated to private cloud
- **2degrees** (NZ): sovereign AI platform for data residency
::::
:::

[Before connecting AI to your data: where does it go, who can see it, what are the constraints?]{.amber}
...
- [A specialized small model can outperform a large model on narrow tasks]{.amber}
::::
:::
