...
Download these files and add them to a Claude Code session:
...
:::{.info-box}
[**Google Meet**]{.box-title}

Join at [meet.google.com/grn-mrsu-wkt](https://meet.google.com/grn-mrsu-wkt) --- you will share your screen when called on.
:::
...
2. Share your screen via Google Meet
...
:::{.explainer}
The goal is not a "right" answer --- it is a [defensible]{.amber} set of assumptions grounded in evidence.
:::
