...
[OpenRouter](https://openrouter.ai/models) is a marketplace that routes API calls to hundreds of models from dozens of providers --- a single place to see what exists and compare pricing.
...
Visit [openrouter.ai/models](https://openrouter.ai/models) to see the full landscape of available models.
:::
