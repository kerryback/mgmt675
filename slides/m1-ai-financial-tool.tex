...
\toprule
\textbf{Table} & \textbf{Content} & \textbf{Key Fields} \\
\midrule
\textbf{SEP} & Daily prices & \texttt{ticker}, \texttt{date}, \texttt{close} (split-adjusted), \texttt{closeadj} (fully adjusted), \texttt{volume} \\
\textbf{DAILY} & Valuation & \texttt{ticker}, \texttt{date}, \texttt{marketcap}, \texttt{pb}, \texttt{pe}, \texttt{ps} \\
\textbf{TICKERS} & Company info & \texttt{ticker}, \texttt{name}, \texttt{sector}, \texttt{industry} \\
\textbf{SF1} & Fundamentals & \texttt{revenue}, \texttt{netinc}, \texttt{assets}, \texttt{equity}, \texttt{debt}, \texttt{roe}, \ldots \\
\bottomrule
\end{tabular}
\end{center}
\vfill
...
\begin{frame}[shrink=5]{Account Options and Model Access}
