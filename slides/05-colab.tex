...
\centering\href{https://kerryback.com/mgmt675/exercises/returns.xlsx}{Download returns.xlsx}
\end{shadedbox}
\end{center}
\end{frame}
...
\begin{baritemize}
  \item Download the Excel file with expected returns and covariance matrix
  \item Find the tangency portfolio
  \item Plot the efficient frontier
\end{baritemize}

\begin{center}
\begin{shadedbox}[width=0.7\textwidth]
\centering\href{https://kerryback.com/mgmt675/exercises/meanvariance.xlsx}{Download meanvariance.xlsx}
\end{shadedbox}
\end{center}
\end{frame}
