...
\begin{frame}[fragile]{Example: Earnings Call Skill}
\begin{columns}[T]
\begin{column}{0.45\textwidth}
...
---
name: earnings-call
description: "Analyze earnings call
...
# Workflows
1. Parse transcript from uploaded
   file or pasted text
2. Extract financial figures and
...
\begin{shadedbox}
Every skill has a \textbf{name}. That name becomes a \textbf{slash command} you can type in the Code tab (or CLI or VS Code).
\end{shadedbox}
\vspace{0.3cm}
\begin{columns}[T]
\begin{column}{0.5\textwidth}
