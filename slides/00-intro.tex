...
\begin{enumerate}
  ...
  \item How AI agents can automate repetitive tasks in finance
  \item Methods for reducing the hallucination rate of AI
  \item How AI can be used for trading on news sentiment
\end{enumerate}
\end{frame}
