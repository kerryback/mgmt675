...
\begin{shadedbox}\centerline{Deloitte Q4 2025 CFO Signals Survey --- 200 CFOs at \$1B+ companies}\end{shadedbox}
\vspace{0.3cm}
\begin{columns}[T]
...
\begin{shadedbox}\centerline{Marie Myers, CFO of Hewlett Packard Enterprise (\#143 on Fortune 500)}\end{shadedbox}
\vspace{0.2cm}
\begin{columns}[T]
\begin{column}{0.5\textwidth}
...
\begin{itemize}\small
  ...
  \item Finance teams spent weekends compiling reports
...
\begin{itemize}\small
  ...
  \item \textbf{90\%} of manual prep effort eliminated
  \item Reporting cycle time reduced \textbf{40\%}
  \item Processing costs down \textbf{25\%}
