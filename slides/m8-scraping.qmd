...
Most companies post earnings call [audio webcasts]{.amber} on their investor relations page. If no free transcript exists, you can create your own.

:::{.two-col}
::::{.column}
**How it works**

1. Download the audio file from the company's IR page (often an MP3 or linked webcast)
2. Run it through a speech-to-text model
3. The output is a full text transcript
...
- **OpenAI Whisper API** --- $0.006/min, fast, accurate
- **Local Whisper** --- free, runs on your machine (`pip install openai-whisper`)
- **AssemblyAI** --- speaker diarization (labels who is speaking)

**Limitations**

- Audio quality varies (phone lines, accents)
- No speaker labels with basic Whisper (need diarization for Q&A attribution)
- A 60-min call ≈ [8,000--12,000 words]{.amber} of transcript
::::
:::
