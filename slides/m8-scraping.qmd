...
- Copyrighted content (transcripts, articles) can be used for personal research but not redistributed
:::
...
Magnolia is the ideal scraping target: filings are freely available on EDGAR, the business model (onshore E&P) is straightforward to value, and as a Houston-based small-cap, analyst coverage is thin enough that building your own research library adds genuine value.

- **Public since 2018** --- 7 years of filings, enough for trend analysis
- **Houston-headquartered** --- relevant to Rice students
- **Simple business model** --- onshore oil & gas, easy to understand financially
- **Thin coverage** --- free transcript sources are spotty, so we need multiple techniques
...
```
| ASSETS                    | Dec 31, 2025 | Dec 31, 2024 |     | REVENUES         | 2025      | 2024      |
|---------------------------|--------------|--------------|     |------------------|-----------|-----------|
| Cash and equivalents      | $266,785     | $260,049     |     | Oil revenues     | $918,027  |$1,046,675 |
| Total current assets      | 442,435      | 410,824      |     | NGL revenues     | 203,566   | 178,934   |
| TOTAL ASSETS              | $2,903,092   | $2,820,835   |     | Total revenues   |1,311,845  |1,315,886  |
...
Example output: `magnolia/transcripts/mgy-q3-2025-earnings.md`
...
1. Find the company's CIK on EDGAR (search `https://efts.sec.gov/LATEST/search-index?q=COMPANY_NAME`)
...
- At least 2 earnings call transcripts (from Motley Fool, or transcribed from IR audio)
- 5+ news articles

This corpus will be used in Module 11 (RAG) exercises. Store everything in a `corpus/` folder in your project.
