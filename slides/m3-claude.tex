...
\title{Module 3: Claude Desktop and Claude Code}
\author{Kerry Back}
\date{}
...
\begin{itemize}
  \item \textbf{Windows:} \href{https://bi-to-ai.kerryback.com/install/windows/INSTALL.bat}{bi-to-ai.kerryback.com/install/windows/INSTALL.bat}
  \item \textbf{Mac:} \href{https://bi-to-ai.kerryback.com/install/mac/install.sh}{bi-to-ai.kerryback.com/install/mac/install.sh}
\end{itemize}
\end{frame}
...
\small\textit{``Create an Excel workbook with a loan amortization table for a \$300{,}000 mortgage at 6.5\% annual interest with a 30-year term and monthly payments.  Use formulas so I can change the loan amount, rate, and term.  Include columns for payment number, payment, principal, interest, and remaining balance.''}
\end{shadedbox}
\end{column}
\end{columns}
\end{frame}
