...
- Financial analysis with AI: mean-variance, DCF, capital budgeting, deliverables
- Skills, makers & checkers, web scraping, chatbots & agents
- Corporate AI deployment (guardrails, governance)
- Live cases: Magnolia Oil & Gas, The Sneaker Project
...
```{mermaid}
%%| fig-width: 16
%%{init: {'theme': 'base', 'themeVariables': {'fontSize': '36px'}, 'flowchart': {'nodeSpacing': 80, 'rankSpacing': 100, 'padding': 24, 'useMaxWidth': true}}}%%
flowchart LR
  ...
  style D fill:#eff6ff,stroke:#3b82f6,stroke-width:2px,color:#0f172a,font-size:36px,padding:20px
  style CE fill:#eff6ff,stroke:#3b82f6,stroke-width:2px,color:#0f172a,font-size:36px,padding:20px
  style VDB fill:#eff6ff,stroke:#3b82f6,stroke-width:2px,color:#0f172a,font-size:36px,padding:20px
  style UQ fill:#dbeafe,stroke:#3b82f6,stroke-width:2px,color:#0f172a,font-size:36px,padding:20px
  style EQ fill:#dbeafe,stroke:#3b82f6,stroke-width:2px,color:#0f172a,font-size:36px,padding:20px
  style R fill:#dbeafe,stroke:#3b82f6,stroke-width:2px,color:#0f172a,font-size:36px,padding:20px
  style LLM fill:#fef3c7,stroke:#f59e0b,stroke-width:2px,color:#0f172a,font-size:36px,padding:20px
  style A fill:#fff7ed,stroke:#ea580c,stroke-width:2px,color:#0f172a,font-size:36px,padding:20px
```
