...
## Problem 1: Words Mean Different Things in Finance
...
Bag of words can't handle word order, negation ("not profitable" vs. "profitable"), or relative importance (forward guidance outweighs trailing results). We need models that understand [sentences, not just words]{.amber}.
...
[FinBERT]{.amber} (Araci, 2019) is a neural network trained to understand financial sentences --- not just count words.
...
Compare bag of words, Loughran-McDonald, and FinBERT on a variety of sentences --- including negation, hedging, and finance-specific language.
